...
const AudioCard = () => {
  ...
  return (
    <div className="flex pb-4 flex-col h-full items-center gap-4">
      <div
        ref={lyricsContainerRef}
        className="custom_scroll h-full w-full space-y-2 overflow-y-auto rounded-lg border bg-[#131313] py-[1rem] text-center [&::-webkit-scrollbar-thumb]:bg-border [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-2.5"
      >
